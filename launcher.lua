...
EzLauncher.StatusName.Text = "Atrium Hub"
...
EzLauncher.StatusName_2.Text = "Atrium API"
...
EzLauncher.StatusName_3.Text = "Atrium Launcher"
...
local launcherData = game:GetService("HttpService"):JSONDecode(
	(game:HttpGet("https://raw.githubusercontent.com/AtriumAdmin/Shhhh/main/updates.lua")));
