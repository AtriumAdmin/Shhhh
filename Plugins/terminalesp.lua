...
terminalPrint("Initializing Atrium Hub ESP Terminal...", "b");
...
terminalPrint("Loaded Atrium Hub ESP Terminal successfully! Type cmdlist to get the new list of commands.", "b");