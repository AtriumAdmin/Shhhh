...
terminalPrint("Loaded Atrium Ez Hub Aimbot Terminal...", "b");
...
terminalPrint("Loaded Atrium Hub Aimbot Terminal successfully! Type cmdlist to get the new list of commands.", "b");